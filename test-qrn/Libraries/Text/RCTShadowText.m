                                                ...
                                                opacity:(CGFloat)opacity
{
  ...
  BOOL needFontLoaded = ![_bridge.iconFontManager fontHasLoadedForFamily:fontFamily] && fontFamily && ![[UIFont familyNames] containsObject:fontFamily];
  
  UIFont *font;
  if (!needFontLoaded)
  {
     font = [RCTConvert UIFont:nil withFamily:fontFamily
  ...
  for (RCTShadowView *child in [self reactSubviews]) {
    if ([child isKindOfClass:[RCTShadowText class]]) {
      ...
      if (!needFontLoaded) {
        ...
        [_bridge.iconFontManager requestFontFamilyToLoad:fontFamily forTag:self.reactTag];
      }
