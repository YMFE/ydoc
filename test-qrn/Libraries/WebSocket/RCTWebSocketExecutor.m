...
static NSString *s_webSocketHost;

+ (void)setWebSocketHost:(NSString *)host{
  s_webSocketHost = [host copy];
}
...
{
  if (!s_webSocketHost) {
    s_webSocketHost = @"http://localhost:8081";
  }
...
//    _url = [RCTConvert NSURL:URLString];
    NSString *URLString = [NSString stringWithFormat:@"%@/debugger-proxy?role=client", s_webSocketHost];
    _url = [RCTConvert NSURL:URLString];
  }
