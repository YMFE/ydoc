...
var filterObject = function filterObject(object, callback, context) {
  if (!object) {
    return null;
  }
  var result = {};
  ...
  propTypes: {
   ...
   /**
     ...
     * aspect ratio of the src.
      */
    resizeMode: PropTypes.oneOf(['cover', 'contain', 'stretch', 'center', 'centerCrop', 
      'focusCrop', 'centerInside', 'fitCenter', 'fitStart', 'fitEnd', 'fitXy']),
    /**
     * Uesd to setting point value when scale type is focus crop
     */
