...
///////// QAdd  ///////////////
  ...
  /**
   * 强制刷新 ScrollView 的 subView
   * 解决ScrollView中内容被错误的clip掉的问题
   * 在页面渲染后调用哦~
   */
  forceUpdateClippedSubviews: function() {
    RCTScrollViewManager.forceUpdateClippedSubviews(
      ReactNative.findNodeHandle(this)
    );
  },
///////// QAdd End  //////////// 
