...
// zilong.xu@qunar.com 劫持非Release环境下的nativeLoggingHook，让其不输出以提高性能
const isRelease = global["qunar-react-native"] ? 
  ['dev', 'beta', null, undefined].indexOf(global["qunar-react-native"].build)==-1 : false;
if (!!global.nativeLoggingHook && isRelease) {
