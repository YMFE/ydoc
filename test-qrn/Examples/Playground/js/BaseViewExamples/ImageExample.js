...
class NetworkImageCallbackExample extends Component {
    constructor() {
        super();
        this._loadEventFired = this._loadEventFired.bind(this);
        this.state = {
            events: [],
            mountTime: new Date(),
        };
            ...
            render: function() {
                return (
                    <View style={styles.horizontal}>
                        <Image source={{uri: require('QImageSet').uie_thumb_normal}} style={styles.icon} />
                        <Image source={{uri: require('QImageSet').uie_thumb_selected}} style={styles.icon} />
                        <Image source={{uri: require('QImageSet').uie_comment_normal}} style={styles.icon} />
                        <Image source={{uri: require('QImageSet').uie_comment_highlighted}} style={styles.icon} />
                    </View>
                );
            },
        },
            ...
            render: function() {
                return (
                    <View>
                        <View style={styles.horizontal}>
                            <Image
                                source={{uri: require('QImageSet').uie_thumb_normal}}
                      ...
                      <View key={index}>
                        <View style={styles.horizontal}>
                          <View>
                            ...
                            <Image
                              ...
                              resizeMode={Image.resizeMode.fitCenter}
                              source={image}
                            />
                          </View>
                          <View style={styles.leftMargin}>
                            ...
                            <Image
                              style={styles.resizeMode}
                              resizeMode={Image.resizeMode.centerCrop}
                              source={image}
                            />
                          </View>
                        </View>
                        <View style={styles.horizontal}>
                          <View>
                            ...
                            <Image
                              style={styles.resizeMode}
                              resizeMode={Image.resizeMode.fitXy}
                              source={image}
                            />
                          </View>
                          { Platform.OS === 'ios' ?
                        ...
                        <View style={styles.horizontal}>
                          <View>
                            ...
                            <Image
                              style={styles.resizeMode}
                              resizeMode={Image.resizeMode.fitStart}
                              source={image}
                            />
                          </View>
                          <View style={styles.leftMargin}>
                            ...
                            <Image
                              style={styles.resizeMode}
                              resizeMode={Image.resizeMode.fitEnd}
                              source={image}
                            />
                          </View>
                        </View>
                        <View style={styles.horizontal}>
                          <View>
                            ...
                            <Image
                              style={styles.resizeMode}
                              resizeMode={Image.resizeMode.focusCrop}
                              focusPoint={{x:0,y:0}}
                              source={image}
                            />
                          </View>
                        ...
                        <View style={styles.horizontal}>
                          ...
                          <View style={styles.leftMargin}>
                            ...
                            <Image
                              style={styles.resizeMode}
                              resizeMode={Image.resizeMode.centerInside}
                              source={image}
                            />
                          </View>
                        </View>
