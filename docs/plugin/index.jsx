...
plugins: 
  ...
  - { title: 'ydoc-plugin-search', href: 'https://www.npmjs.com/package/ydoc-plugin-search', desc: '为 YDoc 提供搜索功能' }
  - { title: 'ydoc-plugin-vue-styleguide', href: 'https://www.npmjs.com/package/ydoc-plugin-vue-styleguide', desc: '根据代码结构和注释，生成 vue 组件文档，基于 vue-styleguide' }
